...
zooAnimals.forEach(zooAnimals => {
  displayNames.push(
    zooAnimals.animal_name + "," + " Scientific: " + zooAnimals.scientific_name
  );
});
...
*/
// const lowCaseAnimalNames = []; really threw me off in this exercise
...
const lowPop = [];
lowPopulationAnimals.forEach(lowPopulationAnimals => {
  lowPop.push(lowPopulationAnimals.animal_name);
});

console.log(lowPopulationAnimals);
console.log(lowPop + " are all screwed");
